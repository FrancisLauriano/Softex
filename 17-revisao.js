...
let nota2 = readline1.questionFloat(console.log(`Informe a 1º Nota:`));
let nota3 = readline1.questionFloat(console.log(`Informe a 1º Nota:`));
...
let ano = readline2.questionInt(console.log(`Informe o ano que deseja verificar:`));

if((ano >= 1582) && (ano%400 === 0) && ((ano%4 === 0) && ano%100 !== 0)){
    console.log(`De acordo com calendário gregoriano, o ${ano} é BISSEXTO`);
}else if ((ano >= 1582) && (ano%400 !== 0) && ((ano%4 !== 0) && ano%100 === 0)){
    console.log(`De acordo com Calendário Gregoriano, o ${ano} é NÃO BISSEXTO`);
}else if(ano < 1582 && ano%4 === 0){
...
let estado  = readline3.questionInt(console.log(`Informe o número que corresponde ao estado de destino do produto:\n1.MG\t2.SP\t3.RJ\t4.MS`));
...
switch (estado) {
    case 1:
        ...
        console.log(`O valor final do seu produto acrescido de impostos é: ${valorComImposto.toFixed(2)}`);
        break;
    case 2:
...
let numeroRecebido = readline4.questionInt(console.log(`Digite um número:`));
...
let diasTrabalho = readline5.questionInt(console.log(`Digite a quantidade de dias trabalhados:`));
let salarioBruto = 30 * diasTrabalho;
let salarioLiquido = salarioBruto - (salarioBruto * 0.08);

console.log(`O salário líquido do funcionários em ${diasTrabalho} dias é: R$${salarioLiquido.toFixed(2)}`);
...
let horasNormais = readline7.questionInt(console.log(`Infome o total de horas normais trabalhadas no ano: `));
let horasExtras = readline7.questionInt(console.log(`Infome o total de horas extras realizadas no ano: `));
let salarioNormal = horasNormais*10;
let salarioExtra = horasExtras*15;
let salarioAnual = salarioNormal+salarioExtra;
console.log(`O trabalhador recebeu salário anual total R$${salarioAnual.toFixed(2)}. Sendo:\nSalário total de horas normais: ${salarioNormal.toFixed(2)}\nSalário total de horas extras: ${salarioExtra.toFixed(2)}`);
...
function conversaoTemperatura(opcaoConversao, conversaoTemperatura) {
...
function diasMes (mes, ano){
    ...
    ano = readline10.questionInt(console.log(`Informe o ano:`));
    console.log(`Informe o número correspondente ao mês que deseja verificar:`);
    mes = readline10.questionInt(console.log(`1.JANEIRO\n2.FEVEREIRO\n3.MARÇO\n4.ABRIL\n5.MAIO\n6.JUNHO\n7.JULHO\n8.AGOSTO\n9.SETEMBRO\n10.OUTUBRO\n11.NOVEMBRO\n12.DEZEMBRO`));
