// Crie uma função recursiva chamada somaRecursiva que receba um número inteiro positivo n 
...
//   Escreva uma função chamada fibonacci que receba um número n como parâmetro e 
